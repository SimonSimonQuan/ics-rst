...
function user_guess() {                                                                         //picks a random word as the answer
    let list = ["Tiger", "Coach", "Equal", "Fraud", "field", "mayor", "third", "worth", "might", "unity", "waste", "quick", "rural", "rival", "meant", "input", "earth", "night", "dozen", "guard", "juicy", "dizzy", "jazzy", "music", "piano", "habit", "kabab", "label", "macaw", "oasis", "vague", "yacht", "clone", "prove", "spice", "mercy", "saucy", "eagle", "aisle", "ounce", "outro", "actor", "apply", "bride", "bloom", "blush", "candy", "chair", "check", "clamp", "clean", "clerk", "cloud", "dance", "dear", "flame", "flick", "flock", "force", "fresh", "grasp", "grind", "grape", "grief", "haste", "hitch", "hover", "jolly", "joint", "latch", "liver", "lemon", "lunar", "lapse", "lolly", "melon", "mocha", "march", "molar", "mount", "night", "noble", "ocean", "piano", "plaza", "proud", "pulse", "quake", "quick", "quiet", "rival", "roast", "sharp", "sheer", "swoop", "shook", "stare", "straw", "spike", "stone", "style", "stung", "taste", "tiger", "tired", "vivid", "vapor", "vocal", "vowel", "waste", "wrist", "widen", "whisk", "wager", "water", "weary", "worse", "yield", "youth", "zesty", "angel", "bingo", "blaze", "blink", "blink", "brace", "candy", "clamp", "creek", "drift", "dove", "eager", "echo", "elite", "frown", "grate", "gloom", "happy", "lapse", "lemon", "latch", "liven", "moist", "mirth", "nudge", "oiled", "plumb", "prone", "roast", "spine", "tiger", "toast", "wager", "wrist"]
